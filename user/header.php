  ...
  <div class="container mx-auto flex justify-between items-center py-2 px-4">
    ...
    <div class="container mx-auto flex justify-between items-center py-2 px-4">
      ...
      <div class="hidden md:flex items-center space-x-4">
        <a href="login.php" class="hover:bg-green-800 rounded px-4 py-2 transition duration-300">เข้าสู่หน้าสมาชิก</a>
    ...
    <div class="mobile-menu hidden md:hidden">
      <a href="login.php" class="block hover:bg-green-800 rounded px-4 py-2 transition duration-300 font-sans">เข้าสู่หน้าสมาชิก</a>
