...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 mt-3">
        ...
        <div class="mb-4 flex justify-between items-center">
            <h1 class="text-2xl font-semibold">การจัดการข่าว</h1>
        ...
        <!-- News Add Modal -->
        <!-- Modal Background -->
        <div id="addNewsModal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">เพิ่มข่าวสาร</h3>
                                <div class="mt-2">
                                    <!-- Form inside modal -->
                                    <form id="addNewsForm" method="post" enctype="multipart/form-data" action="add_news.php">
                                        <div class="mb-4">
                                            <label for="title" class="block text-gray-700 text-sm font-bold mb-2">ชื่อ:</label>
                                        ...
                                        <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-500 text-base font-medium text-white hover:bg-blue-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm" onclick="submitAddNewsForm()" name="submit">ยืนยัน</button>
        ...
        <!-- Edit News Modal -->
        <div id="editNewsModal" class="fixed inset-0 z-10 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">แก้ไขข่าวสาร</h3>
                                <div class="mt-2">
                                    <!-- Form inside modal -->
                                    <form id="editNewsForm" method="post" action="edit_news.php" enctype="multipart/form-data">
                                        <!-- Dynamic content will be loaded here -->
                                        <div class="mt-2">
                                            <label for="title" class="block text-sm font-medium text-gray-700">ชื่อ</label>
                                            <input type="text" name="title" id="title" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm form-input" placeholder="News Title">
                                        </div>
                    ...
                    <?php foreach ($newsItems as $item) { ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                ...
                                <a href="delete_news.php?id=<?php echo $item['id']; ?>" class="py-1 px-3 bg-red-500 text-white rounded hover:bg-red-600 transition duration-300 ease-in-out">ลบ</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <script>
        ...
        function openEditModal(newsId) {
            ...
            <div class="mb-4">
                <label for="title" class="block text-gray-700 text-sm font-bold mb-2">ชื่อ:</label>
                <input type="text" name="title" value="${data.title}" id="title" required class="shadow border rounded w-full">
            </div>
            <div class="mb-4">
                <label for="description" class="block text-gray-700 text-sm font-bold mb-2">คำอธิบาย:</label>
            ...
            <div class="mb-4">
                <label for="image" class="block text-gray-700 text-sm font-bold mb-2">รูปเก่า:</label>
